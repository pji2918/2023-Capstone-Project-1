...
public class Kraken : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        hpBarObj.transform.GetChild(0).GetComponent<TextMeshProUGUI>().text = string.Format("BOSS: {0}", LocalizationSettings.StringDatabase.GetLocalizedString("UI", "boss_kraken"));
